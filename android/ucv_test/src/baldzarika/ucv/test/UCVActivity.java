...
public class UCVActivity
	extends Activity
	implements GLSurfaceView.Renderer, Callback, PreviewCallback

{
	static {
		System.loadLibrary("ucv_test");
	}
	...
	public GLSurfaceView.EGLContextFactory makeContextFactory()
	{
	...
	private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
        	for (int i = 0; i < configs.length; i++) {
                ...
                {
                	//Log.w("UCV", String.format("choosed configuration %d", i));
        ...
        private void printConfigs(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            ...
            Log.w("UCV", String.format("%d configurations", numConfigs));
            for (int i = 0; i < numConfigs; i++) {
                Log.w("UCV", String.format("Configuration %d:\n", i));
	...
	public GLSurfaceView.EGLConfigChooser makeConfigChooser(int r, int g, int b, int a, int depth, int stencil)
	{
	...
	public native boolean onTouchEvent(MotionEvent me);
	...
	public native void onPreviewFrame(byte[] data, Camera camera);
       
    protected GLSurfaceView m_GLView;
    protected SurfaceView 	m_CameraPreview;
    protected Camera		m_Camera;
    protected long			m_Native;
}